...
export const ChangePrivilegeBody = async(body, jwt) => {
...
export const UpdateUserAdminBody = async (body, options, jwt) => {
    let err, response = await axios.post(UpdateUserURL, body, options, {headers:{jwt: jwt}});
